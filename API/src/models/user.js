...
userSchema.methods.sendResetMail = function(oldtoken, user) {
  return new Promise((resolve, reject) => {
    ...
    transporter.sendMail({
      ...
      text: 'Hi',
      html: `Hi ${user.username}, to change your password for Hypertube, please click on <a href='http://localhost:3000/reset_password/?_id=${user._id}&token=${token}'>this link</a>`,
    })
      .then((res) => {
